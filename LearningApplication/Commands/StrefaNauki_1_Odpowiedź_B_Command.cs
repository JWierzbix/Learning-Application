...
{
    class StrefaNauki_1_Odpowiedź_B_Command: CommandBase
    {
        ...
        public StrefaNauki_1_Odpowiedź_B_Command(NavigationStore navigationStore, Lista_Zestawów lista_zestawów, Zestaw zestaw, string[] dane, StrefaNauki_1_ViewModel strefaNauki_1_ViewModel)
        {
